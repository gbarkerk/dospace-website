...
$to = "graham@whitefire2.com";
$subject = "Dospace Booking Form";
...
if(isset($_POST["comment"])){
    if (strlen($message) < 10) {
        if (!$message) {
            $errors[] = "You must enter your basic requirements.";
        } else {
...
if ($errors) {
    ...
    if(mail($to, $subject, $mailBody, $headers)){
        echo '<div class="alert alert-success">Thank You for enquiring about becoming a member. Our barge community manager will contact you shortly</div>';
    }
}
